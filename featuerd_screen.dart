...
import 'package:login_page/widgets/search_textfield.dart';
import 'package:speech_recognition/speech_recognition';
...
class _FeaturedScreenState extends State<FeaturedScreen> {
  ...
  void initSpeechRecognizer() {
    speech.setAvailabilityHandler((result) {
      if (result == 'Available') {
...
final categoryList = <Category>[
  Category(name: 'Category 1', thumbnail: 'assets/cat1.png', noOfCourses: 8),
  Category(name: 'Category 2', thumbnail: 'assets/cat2.png', noOfCourses: 12),
  Category(name: 'Category 3', thumbnail: 'assets/cat3.png', noOfCourses: 6),
  Category(name: 'Category 4', thumbnail: 'assets/cat4.png', noOfCourses: 10),
];
